...
title: 'Preprint. Compliance with open access mandates and its effects on research visibility: The case of the Spanish National Plan of R&D'
categories: ['open access mandates', 'open access', 'open science', 'project funding', 'spanish plan of r&d']
---

This page includes information on a paper to be published in the journal Scientometrics. Here you have access to the preprint and postprint versions.
